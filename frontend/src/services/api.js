...
export const resumeApi = {
  ...
  async previewLinkedIn(url) {
    ...
    const response = await fetch(
      `${API_BASE}/resumes/import/linkedin/preview`,
      {
        method: "POST",
        headers,
  ...
  async downloadPdf(resumeId, version = "enhanced") {
    ...
    const token = await user.getIdToken();
    const response = await fetch(
      `${API_BASE}/resumes/${resumeId}/download?version=${version}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const communityApi = {
  ...
  async getChannelMessages(channelId, page = 1) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/community/channels/${channelId}/messages?page=${page}`,
      {
        method: "GET",
        headers,
      },
  ...
  async cancelScheduledPost(postId) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/community/posts/${postId}/schedule`,
      {
        method: "DELETE",
        headers,
      },
  ...
  async getComments(postId, page = 1) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/community/posts/${postId}/comments?page=${page}`,
      {
        method: "GET",
        headers,
      },
  ...
  async toggleLikeComment(commentId) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/community/comments/${commentId}/like`,
      {
        method: "POST",
        headers,
      },
  ...
  async getConversationMessages(conversationId, page = 1) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/community/conversations/${conversationId}/messages?page=${page}`,
      {
        method: "GET",
        headers,
      },
  ...
  async search(query, type = "all") {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/community/search?q=${encodeURIComponent(query)}&type=${type}`,
      {
        method: "GET",
        headers,
      },
...
export const fellowshipApi = {
  ...
  async deleteChallenge(challengeId) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/fellowship/challenges/${challengeId}`,
      {
        method: "DELETE",
        headers,
      },
  ...
  async applyToChallenge(challengeId, data) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/fellowship/challenges/${challengeId}/apply`,
      {
        method: "POST",
        headers,
        body: JSON.stringify(data),
  ...
  async getChallengeProposals(challengeId) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/fellowship/challenges/${challengeId}/proposals`,
      {
        method: "GET",
        headers,
      },
  ...
  async updateProposalStatus(proposalId, status, feedback) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/fellowship/proposals/${proposalId}/status`,
      {
        method: "PUT",
        headers,
  ...
  async getChatRoom(roomId) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/fellowship/chat/rooms/${roomId}`,
      {
        method: "GET",
        headers,
      },
...
export const paymentApi = {
  ...
  async releaseFunds(roomId) {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${API_BASE}/payments/release-funds/${roomId}`,
      {
        method: "POST",
        headers,
      },
