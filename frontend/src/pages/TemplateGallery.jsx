...
import Retro8bitContact from "../components/portfolio/templates/2D_Retro_8bit/Contact";
    ...
    <div className="min-h-screen bg-background text-foreground p-8 pt-24 transition-colors duration-300">
      ...
      <div className="mt-12">
        <div className="mb-4 flex items-center gap-3 px-1">
          ...
          <h2 className="text-lg font-semibold text-foreground/70">2D Retro 8bit Theme — Contact Section</h2>
        </div>
        <div className="overflow-hidden rounded-2xl border border-border">
          <Retro8bitContact />
        </div>
