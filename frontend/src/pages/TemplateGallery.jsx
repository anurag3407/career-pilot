...
export default function TemplateGallery() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      {/* --- INLINE VISUAL PREVIEWS FLOW --- */}
        <div   className="mt-20 border-t border-border pt-12">
          <h2 className="text-2xl font-bold mb-2">Live Component & Flow Breakdowns</h2>
          <p className="text-muted-foreground text-sm mb-8">Inspect section configurations and interactive responsive layouts below.</p>
          
          {/* Holographic Theme Section */}
          <div className="mt-8">
            <div className="mb-4 flex items-center gap-3 px-1">
          ...
          {/* --- SCROLL CONTAINED INTERACTIVE FRAMES --- */}
          ...
          <TemplatePreviewFrame
            label="Cassette Mixtape — Retro Music Style Template"
            badgeColor="bg-orange-500/20 text-orange-400 border-orange-500/30"
          >
            <CassetteMixtape portfolioData={aiDraft} />
          </TemplatePreviewFrame>

          <TemplatePreviewFrame
             label="Recipe Cookbook — Creative Cooking Style Template"
             badgeColor="bg-orange-500/20 text-orange-400 border-orange-500/30"
          >
             <RecipeCookbookPortfolio portfolioData={aiDraft} />
          </TemplatePreviewFrame>
        </div>
      </div>
