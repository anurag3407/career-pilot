        ...
        >
            ...
            <div className="flex flex-wrap gap-2">
                {project.techStack.map(tech => (
                    <span key={tech} className="text-xs px-2 py-1 bg-muted rounded-lg text-muted-foreground">
                        {tech}
                    </span>
                ))}
            </div>
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Explore completed fellowship projects from our community</p>
            </div>
