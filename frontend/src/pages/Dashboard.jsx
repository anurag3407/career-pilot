...
import RepoRadarChart from '../components/github/RepoRadarChart'
                ...
                {[
                  {
                    ...
                    text: 'Use our AI to tailor your resume for each job application'
                  },
                  {
                    icon: Target,
                    color: 'emerald-500',
                    title: 'Track Everything',
                    text: 'Keep notes and update statuses to stay organized in your job hunt'
                  },
                  {
                    icon: TrendingUp,
                    color: 'primary',
                    title: 'Follow Up',
                    text: "Don't forget to follow up on applications after a week"
                  }
                ].map((tip, idx) => (
                  <div
                    key={idx}
                    className="p-8 rounded-[2rem] bg-card border border-border hover:border-primary/30 hover:shadow-xl transition-all group"
                  >
                    <div className="w-14 h-14 bg-muted rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                      <tip.icon className="w-7 h-7 text-foreground" />
                    </div>
