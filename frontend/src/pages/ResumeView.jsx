          ...
          >
            ...
            <div className="flex gap-4 border-b border-border">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="h-10 bg-muted rounded w-28 animate-pulse"
                />
              ))}
            </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Last modified:{" "}
              {formatDate(resume?.lastModified || resume?.createdAt)}
            </p>
          </div>
              ...
              <Card className="mt-6 border-primary/20 bg-primary/5 relative overflow-hidden animate-pulse">
                <div className="flex flex-col items-center py-10 px-4">
                  ...
                  >
                    ...
                    {scoringStep === 1 &&
                      "🔍 Analyzing keyword relevance & density..."}
                    {scoringStep === 2 &&
                      "⚡ Measuring impact statements & formatting..."}
                    {scoringStep === 3 &&
                      "📈 Compiling score and suggestions..."}
                  </motion.p>

                  <p className="text-xs text-muted-foreground mt-4 text-center max-w-sm">
                    This might take a few seconds as the AI evaluates your
                    resume against industry benchmarks and formats custom
                    suggestions.
                  </p>
                </div>
              </Card>
            ...
            {scoreData && (
              <Card className="mt-6">
                ...
                <div className="space-y-4">
                  {Object.entries(scoreData.sections).map(
                    ([section, value]) => (
                      <div key={section}>
