          ...
          <div className="tw-about-grid">
            <FadeIn>
              <div style={{ textAlign: "center" }}>
                <img loading="lazy" src={data.personal.avatar} alt={data.personal.name} style={{ width: 180, height: 180, borderRadius: 0, objectFit: "cover", border: `2px solid ${C.border}`, filter: "sepia(15%) saturate(.85)", marginBottom: 16 }} />
            ...
            {data.projects.map((proj, i) => (
              <motion.div key={i} className="tw-card" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}>
                <div style={{ position: "relative", overflow: "hidden" }}>
                  <img loading="lazy" src={proj.image} alt={proj.title} className="tw-proj-img" />
            ...
            {data.testimonials.map((t, i) => (
              <motion.div key={i} className="tw-card" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }}
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <img loading="lazy" src={t.avatar} alt={t.name} style={{ width: 40, height: 40, borderRadius: 0, objectFit: "cover", border: `1px solid ${C.border}`, filter: "sepia(20%)" }} />
                  <div>
