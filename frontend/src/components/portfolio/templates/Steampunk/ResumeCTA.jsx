    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-4xl mx-auto rounded-2xl border border-amber-700 bg-[#24180f] p-8 md:p-12 text-center">
        ...
        <p className="text-amber-200/80 max-w-2xl mx-auto mb-8">
          Interested in my work? Take a look at my resume to learn more about
          my experience, technical skills, projects, and achievements.
        </p>

        <a
          href="#"
          className="inline-flex items-center gap-2 rounded-lg bg-amber-700 px-6 py-3 font-medium text-white transition hover:bg-amber-600"
        >
          <Download size={18} />
          Download Resume
        </a>
