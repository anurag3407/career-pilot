              ...
              <div className="grid gap-0 xl:grid-cols-[1fr_420px]">
                ...
                >
                  ...
                  <div className="mt-5 overflow-hidden rounded-lg border border-[#3c3c3c] bg-[#0d1117]">
                    <img loading="lazy" src={data.personal.avatar} alt={data.personal.name} className="h-72 w-full object-cover" />
                  ...
                  {data.projects.map((project, index) => (
                    ...
                    >
                      <div className="relative h-56 overflow-hidden bg-[#0d1117]">
                        <img loading="lazy" src={project.image} alt={project.title} className="h-full w-full object-cover transition duration-700 group-hover:scale-105" />
                  ...
                  {data.testimonials.map((testimonial) => (
                    <motion.figure key={testimonial.name} className="rounded-lg border border-[#3c3c3c] bg-[#252526] p-6" variants={item}>
                      ...
                      <figcaption className="mt-6 flex items-center gap-3">
                        <img loading="lazy" src={testimonial.avatar} alt={testimonial.name} className="h-12 w-12 rounded-full object-cover" />
                        <div>
