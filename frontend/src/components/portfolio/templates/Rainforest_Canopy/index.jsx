        ...
        <ForestCard title="Projects">
          <div className="grid sm:grid-cols-2 gap-5">
            {data.projects.map((p, i) => (
              ...
              >
                <img alt=" " src={p.image} alt={p.title} className="w-full h-36 object-cover opacity-80" />
                <div className="p-4">
            ...
            {data.testimonials.map((t, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <img alt=" " src={t.avatar} alt={t.name} className="w-9 h-9 rounded-full object-cover border-2 border-emerald-500/30" />
                  <div>
