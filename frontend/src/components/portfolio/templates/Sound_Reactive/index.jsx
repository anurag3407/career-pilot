  ...
  return (
    ...
    >
      ...
      <div className="h-48 overflow-hidden relative" style={{ transform: "translateZ(20px)" }}>
        ...
        <img loading="lazy" loading="lazy" src={project.image} alt={project.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 opacity-80 group-hover:opacity-100" />
      </div>
            ...
            {data.testimonials.map((test, i) => (
              <div key={i} className="bg-[#0d0d1a]/80 border border-white/5 rounded-3xl p-8 backdrop-blur-md relative overflow-hidden group shadow-xl">
                ...
                <div className="flex items-center gap-4 mb-6 relative z-10">
                  <img loading="lazy" loading="lazy" src={test.avatar} alt={test.name} className="w-14 h-14 rounded-full border-2 border-cyan-400/50" />
                  <div>
