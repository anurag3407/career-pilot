        ...
        <motion.div className="flex flex-col items-center gap-8" {...fadeUp(0.2)}>
          <div className={`p-3 ${neu.circle}`}>
            <div className={`p-2 ${neu.circle}`}>
              <img loading="lazy" src={personal.avatar} alt={personal.name} className="w-48 h-48 md:w-56 md:h-56 rounded-full object-cover" />
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <motion.div {...fadeUp(0.1)}>
            <div className={`${neu.raised} p-6 flex flex-col items-center gap-5`}>
              <img loading="lazy" src={personal.avatar} alt={personal.name} className="w-36 h-36 rounded-full object-cover shadow-[4px_4px_12px_#b8bec7,-4px_-4px_12px_#ffffff]" />
          ...
          {testimonials.map((t, i) => (
            <motion.div key={t.name} {...fadeUp(i * 0.1)} className={`${neu.raised} p-7 flex flex-col gap-5`}>
              ...
              <div className="flex items-center gap-4">
                <img loading="lazy" src={t.avatar} alt={t.name} className="w-12 h-12 rounded-full object-cover shadow-[3px_3px_8px_#b8bec7,-3px_-3px_8px_#ffffff]" />
                <div>
