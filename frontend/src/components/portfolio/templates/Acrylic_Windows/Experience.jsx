        ...
        <div className="flex flex-col gap-8">
          {data.experience.map((exp, i) => (
            ...
            >
              ...
              {/* Spacer pushes card to its side */}
              ...
              <motion.div
                ...
                className="flex-1 backdrop-blur-xl bg-white/[0.07] border border-white/15 rounded-xl p-5"
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#0078D4] text-xs">{exp.company}</p>
                    <p className="text-white/40 text-xs mt-0.5">{exp.period}</p>
                    <p className="text-white/60 text-sm mt-2 leading-relaxed">{exp.description}</p>
                  </div>
                </div>
              </motion.div>
            </div>
