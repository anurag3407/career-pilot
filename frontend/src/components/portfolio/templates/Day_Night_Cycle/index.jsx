          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {data.projects.map((p, i) => (
              <motion.div key={p.title} initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
                ...
                <img loading="lazy" loading="lazy" src={p.image} alt={p.title} className="w-full h-36 object-cover" />
                <div className="p-4">
            ...
            {data.testimonials.map((t, i) => (
              <motion.div key={t.name} initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }}
                ...
                <div className="flex items-center gap-3">
                  <img loading="lazy" loading="lazy" src={t.avatar} alt={t.name} className="w-9 h-9 rounded-full object-cover" />
                  <div>
