            ...
            <motion.div key={i} variants={fadeUp}
              ...
              {project.image && (
                <div className="h-44 overflow-hidden">
                  <img alt=" " src={project.image} alt={project.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
              )}
              <div className="p-5">
          ...
          {data.testimonials.map((t, i) => (
            <motion.div key={i} variants={fadeUp}
              ...
              <div className="flex items-center gap-3">
                <img alt=" " src={t.avatar} alt={t.name} className="w-10 h-10 rounded-full object-cover border-2 border-sky-500/40" />
                <div>
