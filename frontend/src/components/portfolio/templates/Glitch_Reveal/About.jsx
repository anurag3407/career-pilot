    ...
    <SectionWrapper id="about">
      ...
      <div className="grid md:grid-cols-3 gap-12 items-center">
        <div className="md:col-span-1 relative group cursor-crosshair">
          ...
          <img alt=" " src={data.personal.avatar} alt={data.personal.name} className="relative w-full aspect-square object-cover grayscale group-hover:grayscale-0 transition-all duration-300 border border-zinc-800 vibrate-hover" />
