        ...
        {data.projects.map((project, idx) => (
          <div key={idx} className="group relative bg-zinc-900 border border-zinc-800 overflow-hidden hover:border-cyan-500 transition-colors cursor-crosshair">
            ...
            <div className="h-48 overflow-hidden relative">
              <img loading="lazy" loading="lazy" src={project.image} alt={project.title} className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-700" />
