          ...
          <div className="ops-about-grid">
            <FadeIn>
              <div style={{ textAlign: "center" }}>
                <img loading="lazy" src={data.personal.avatar} alt={data.personal.name} style={{ width: 160, height: 160, borderRadius: "50%", objectFit: "cover", border: `3px solid ${C.accent}`, marginBottom: 16 }} />
          ...
          <div className="ops-proj-grid">
            {data.projects.map((proj, i) => (
              <motion.div key={i} className="ops-card" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.07 }}>
                <img loading="lazy" src={proj.image} alt={proj.title} className="ops-proj-img" />
