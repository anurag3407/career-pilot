        ...
        <AnimatePresence mode="wait">
          <motion.div key={current} initial={{ opacity: 0, rotateY: 90 }} animate={{ opacity: 1, rotateY: 0 }} exit={{ opacity: 0, rotateY: -90 }}
            ...
            <div className="flex items-center justify-center gap-4">
              {testimonials[current].avatar && <img src={testimonials[current].avatar} className="w-16 h-16 rounded-full border-2 border-purple-600" alt={testimonials[current].name || "Profile Avatar"} />}
