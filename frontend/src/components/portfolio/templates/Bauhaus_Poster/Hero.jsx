...
const Hero = ({ colors }) => {
  ...
  return (
    <section className="h-screen min-h-screen flex flex-col justify-center items-center p-6 md:p-16 border-b-4 border-black text-center relative overflow-hidden w-full">
      ...
      >
        <img alt=" " src={data.personal.avatar} alt={data.personal.name} className="w-full h-full object-cover grayscale mix-blend-luminosity group-hover:grayscale-0 transition-all duration-700 z-10" />
