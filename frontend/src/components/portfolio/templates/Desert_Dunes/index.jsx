      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <img loading="lazy" src={avatar} alt={name} style={{
          ...
          {data.projects.filter((p) => p.featured).map((project, i) => (
            ...
            >
              <div style={{ position: 'relative', overflow: 'hidden', minHeight: 260 }}>
                <img loading="lazy" src={project.image} alt={project.title} style={{
          ...
          {data.projects.filter((p) => !p.featured).map((project, i) => (
            ...
            >
              <div style={{ position: 'relative', height: 180, overflow: 'hidden' }}>
                <img loading="lazy" src={project.image} alt={project.title} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          ...
          {data.testimonials.map((testimonial, i) => (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, borderTop: `1px solid ${C.sandDark}25`, paddingTop: 20 }}>
                <img loading="lazy" src={testimonial.avatar} alt={testimonial.name} style={{
