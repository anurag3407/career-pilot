    ...
    <div className="min-h-screen bg-white text-black selection:bg-black selection:text-white font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16 md:py-24 border-b-2 border-black grid grid-cols-4 md:grid-cols-12 gap-6">
          ...
          >
            <img loading="lazy" src={personal.avatar} alt={personal.name} className="w-full h-full object-cover grayscale transition-transform duration-700 group-hover:scale-105 group-hover:grayscale-0" />
          </motion.div>
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className={`relative ${index % 3 === 0 ? 'h-[400px] md:h-[600px]' : 'h-[300px] md:h-[400px]'} border-b-2 border-black overflow-hidden bg-gray-100`}>
                  <img loading="lazy" src={project.image} alt={project.title} className="w-full h-full object-cover grayscale transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0" />
            ...
            {testimonials.map((test, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 pt-6 border-t-2 border-black group-hover:border-gray-700">
                  <img loading="lazy" src={test.avatar} alt={test.name} className="w-14 h-14 object-cover border-2 border-black group-hover:border-white" />
                  <div>
