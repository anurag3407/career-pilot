import { createAIProvider, getDefaultProvider, SUPPORTED_PROVIDERS } from '../config/aiProviders.js';
...
export const extractAIProvider = (req, res, next) => {
  try {
    ...
    if (providerHeader && apiKeyHeader) {
      ...
      req.aiProvider = createAIProvider(provider, apiKeyHeader, modelHeader);
